...
function MagicButton({ title, icon, position, handleClicked, otherClasses }: { title: string;
  icon: React.ReactNode; position: string; handleClick?: () => void; otherClases?: string; 
 }) {
  return (
